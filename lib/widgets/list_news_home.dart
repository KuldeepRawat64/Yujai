...
class ListItemNewsHome extends StatefulWidget {
  ...
  @override
  _ListItemNewsHomeState createState() => _ListItemNewsHomeState();
}

class _ListItemNewsHomeState extends State<ListItemNewsHome> {
