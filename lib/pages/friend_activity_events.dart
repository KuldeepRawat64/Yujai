...
class FriendActivityEvents extends StatefulWidget {
  ...
  @override
  _FriendActivityEventsState createState() => _FriendActivityEventsState();
}

class _FriendActivityEventsState extends State<FriendActivityEvents> {
  ...
  retrieveUserDetails() async {
    _future = _repository.retreiveUserEvents(widget.user.uid);
  }
