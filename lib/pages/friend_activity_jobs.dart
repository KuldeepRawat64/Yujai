...
class FriendActivityJobs extends StatefulWidget {
  ...
  @override
  _FriendActivityJobsState createState() => _FriendActivityJobsState();
}

class _FriendActivityJobsState extends State<FriendActivityJobs> {
  ...
  retrieveUserDetails() async {
    _future = _repository.retreiveUserJobs(widget.user.uid);
  }
