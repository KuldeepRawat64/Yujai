...
class AirforceAddInfo extends StatefulWidget {
  final String currentUserId;
  AirforceAddInfo({this.currentUserId});
  @override
  _AirforceAddInfoState createState() => _AirforceAddInfoState();
}
...
class _AirforceAddInfoState extends State<AirforceAddInfo> {
