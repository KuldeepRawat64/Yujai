...
class NavyAddInfo extends StatefulWidget {
  final String currentUserId;
  NavyAddInfo({this.currentUserId});
  @override
  _NavyAddInfoState createState() => _NavyAddInfoState();
}
...
class _NavyAddInfoState extends State<NavyAddInfo> {
